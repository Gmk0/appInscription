                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-eglise-tab" data-toggle="pill"
                            ...
                            aria-selected="false">RELIGIEUX</a>
                    </li>
                        ...
                        <div class="row">
                            <div class="col-md-3 border-right">
                                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img
                                        ...
                                        src="{{asset('/storage/students_images/'.$etudiant->etudiant->Photo)}}"><span
                                        class="font-weight-bold">{{$etudiant->etudiant->Prenom}}</span><span
                                        class="text-black-50">{{$etudiant->etudiant->Email}}</span><span> </span></div>
                                ...
                                <div class="p-3 py-5">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6"><label class="labels">Matricule</label><input type="text"
                                                ...
                                                value="{{$etudiant->etudiant->matricule_etudiant}}"></div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6"><label class="labels">Nationalite</label><input
                                                ...
                                                value="{{$etudiant->etudiant->Nationalite}}"></div>
                                        <div class="col-md-6"><label class="labels">Etat-civil</label><input type="text"
                                                class="form-control form-control-sm wide-font"
                                                placeholder="enter address line 2"
                                                value="{{$etudiant->etudiant->Etat_civil}}"></div>


                                        <div class="col-md-6"><label class="labels">Telephone</label><input type="text"
                                                class="form-control form-control-sm wide-font"
                                                placeholder="enter address line 2"
                                                value="{{$etudiant->etudiant->Telephone}}"></div>

                                        <div class="col-md-12"><label class="labels">Email</label><input type="text"
                                                class="form-control form-control-sm wide-font" placeholder="education"
                                                value="{{$etudiant->etudiant->Email}}"></div>
                                        <div class="col-md-12"><label class="labels">Adresse Etudiant</label><input
                                                type="text" class="form-control form-control-sm wide-font"
                                                placeholder="enter address line 2"
                                                value="{{$etudiant->etudiant->Adresse_etudiant['Avenue']}},{{$etudiant->etudiant->Adresse_etudiant['Commune']}}">
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-12"><label class="labels">Lieu Naissance</label><input
                                                type="text" class="form-control form-control-sm wide-font"
                                                placeholder="country" value="{{$etudiant->etudiant->Lieu_naiss}}"></div>
                                        <div class="col-md-12"><label class="labels">Date Naissance</label><input
                                                type="text" class="form-control form-control-sm wide-font"
                                                value="{{$etudiant->etudiant->Date_naiss}}" placeholder="state"></div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="p-3 py-5">
                                    <div class="d-flex justify-content-between align-items-center experience">
                                        <h4 class="labels">PARENT ETUDIANT</h4>
                                    </div>
                                    <div class="col-md-12"><label class="labels">Nom Pere</label><input type="text"
                                            ...
                                            value="{{$etudiant->etudiant->Nom_Pere}}"></div>
                                    <div class="col-md-12"><label class="labels">Nom Mere</label><input type="text"
                                            class="form-control form-control-sm wide-font"
                                            placeholder="additional details" value="{{$etudiant->etudiant->Nom_mere}}">
                                    </div>
                                    <div class="col-md-12"><label class="labels">Localisation</label><input type="text"
                                            class="form-control form-control-sm wide-font"
                                            placeholder="additional details"
                                            value="{{$etudiant->etudiant->Localisation_parent['Province']}}{{$etudiant->etudiant->Localisation_parent['District']}}{{$etudiant->etudiant->Localisation_parent['Commune']}}">
                                    </div>
                                ...
                                <div class="row p-2 py-3">
                                    <div class="d-flex justify-content-between align-items-center experience">
                                        <h4 class="labels">TUTEUR ETUDIANT</h4>
                                    </div>
                                    <div class="col-md-6"><label class="labels">Nom Tuteur</label><input type="text"
                                            class="form-control form-control-sm wide-font" placeholder="experience"
                                            value="{{$etudiant->etudiant->tuteur['nom_tuteur']}}"></div>
                                    <div class="col-md-6"><label class="labels">Telephone</label><input type="text"
                                            class="form-control form-control-sm wide-font"
                                            placeholder="additional details"
                                            value="{{$etudiant->etudiant->tuteur['tel_tuteur']}}"></div>
                                    <div class="col-md-12"><label class="labels">Adresse</label><input type="text"
                                            class="form-control form-control-sm wide-font"
                                            placeholder="additional details"
                                            value="{{$etudiant->etudiant->tuteur['Avenue']}} Q/{{$etudiant->etudiant->tuteur['Quartier']}} C/{{$etudiant->etudiant->tuteur['Commune']}}">
                                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{$etudiant->etudiant->dossierEtudiant->Aptitude_physique}}</td>
                                            <td class="text-center"><a class="btn btn-primary"
                                                    href="{{asset('/storage/students_doc/'.$etudiant->etudiant->dossierEtudiant->Aptitude_physique)}}">VOIR</a>
                                            </td>
                                            @else
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{$etudiant->etudiant->dossierEtudiant->Certificat_naiss}}</td>
                                            <td class="text-center"><a class="btn btn-primary"
                                                    href="{{asset('/storage/students_doc/'.$etudiant->etudiant->dossierEtudiant->Certificat_naiss)}}">VOIR</a>
                                            </td>
                                            @else
                                            <td class="text-center text-danger">Non disponible</td>
                                            @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{$etudiant->etudiant->dossierEtudiant->Diplome_etat}}</td>
                                            <td class="text-center"><a class="btn btn-primary"
                                                    href="{{asset('/storage/students_doc/'.$etudiant->etudiant->dossierEtudiant->Diplome_etat)}}">VOIR</a>
                                            </td>
                                            @else
                                            <td class="text-center text-danger">Non disponible</td>
                                            @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{$etudiant->etudiant->dossierEtudiant->Bulletin}}
                                            </td>
                                            <td class="text-center"><a class="btn btn-primary"
                                                    href="{{asset('/storage/students_doc/'.$etudiant->etudiant->dossierEtudiant->Diplome_etat)}}">VOIR</a>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{$etudiant->etudiant->dossierEtudiant->recommandation}}</td>
                                            <td class="text-center"><a class="btn btn-primary"
                                                    href="{{asset('/storage/students_doc/'.$etudiant->etudiant->dossierEtudiant->recommandation)}}">VOIR</a>
                                            </td>
                        ...
                        <div>
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6"><label class="labels">Institut</label><input type="text"
                                        class="form-control form-control-sm wide-font" placeholder="first name"
                                        value="{{$etudiant->etudiant->ecclesiaste->institut}}"></div>
                                <div class="col-md-6"><label class="labels">SIGLE</label><input type="text"
                                        class="form-control form-control-sm wide-font" placeholder="surname"
                                        value="{{$etudiant->etudiant->ecclesiaste->sigle}}"></div>
                                <div class="col-md-6"><label class="labels">ETAT</label><input type="text"
                                        class="form-control form-control-sm wide-font" placeholder="surname"
                                        value="{{$etudiant->etudiant->ecclesiaste->etat}}"></div>
                                @endif
                            </div>
                        </div>
            ...
            <div class="card-footer">
                <div class=" d-flex justify-content-between">
                    <a name="" id="" class="btn btn-primary"
                        href="{{route('formulaire',[$etudiant->etudiant->matricule_etudiant])}}"
                        role="button">TELECHARGE</a>
                    @if($etudiant->statut_etudiant == 0)
                    <button wire:click="changeStatut({{$etudiant->id_inscrit}})" class="btn btn-success"
                        role="button">CONFIRMER L'ADMISSION

                    </button>

                    <button wire:click="confirmDelete({{$etudiant->etudiant->id}},'{{$etudiant->etudiant->Nom}}')"
