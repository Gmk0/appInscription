                    ...
                    <div class="bg-white shadow-sm pt-2 pl-2 pr-2 pb-2">
                        ...
                        <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                            ...
                            <li class="nav-item"> <a data-toggle="pill" href="#net-banking" class="nav-link "> <i
                                        class="fas fa-money-check-alt mr-2"></i> Bank </a> </li>
                            <li class="nav-item"> <a data-toggle="pill" href="#net-Mobile" class="nav-link "> <i
                                        class="fas fa-mobile mr-2"></i> PAIEMENT MOBILE </a> </li>
                    ...
                    <div class="tab-content">
                        <div class="pt-2">
                            ...
                            <ul>
                                ...
                                <li>Carte d'identité : 10$</li>
                            </ul>
                            <ul>
                                <li>Nom etudiant : {{$etudiant->etudiant->Nom}}</li>
                                <li>Matricule : {{$etudiant->etudiant->matricule_etudiant}}</li>
                            </ul>
                            <h5><span class="text-success">TOTAL :40$</span> </h5>
                        </div>
                        <hr>
                        <div id="credit-card" class="tab-pane fade show active pt-3" style="min-height:250px;">
                            ...
                            <form role="form" wire:submit.prevent="test" id="payment-form">
                                ...
                                <div class="form-group"> <label for="username">
                                        ...
                                        value="{{$etudiant->etudiant->Nom}} /  " id="card-name" class="form-control"
                                        wire:model="client">
                                    <input type="hidden" name="matricule" id=""
                                        value="{{$etudiant->etudiant->matricule_etudiant}}">
                                </div>
                                ...
                                <div class="card-footer"> <button type="submit"
                                        ...
                                        data-secret="{{ $intent }}" id="card-button"> Confirm Payment </button>
                            </form>
                        </div>
                    </div> <!-- End -->
                    <!-- Paypal info -->
